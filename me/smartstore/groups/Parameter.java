...
public class Parameter {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(minimumSpentTime, parameter.minimumSpentTime) &&
                Objects.equals(minimumTotalPay, parameter.minimumTotalPay);
    }
    ...
    public String toString() {
        return "매개변수{최소 소비시간 =" + minimumSpentTime + ", 소비 금액 =" + minimumTotalPay + "}";
    }
}
