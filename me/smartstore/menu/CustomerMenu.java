...
public class CustomerMenu implements Menu {
        ...
        while(true) {
            try {
                ...
                for(int i = 0; i < inputCount; i++) {
                    ...
                    Customer addCustomer = customerInfoInput(new Customer());
    ...
    private Customer customerInfoInput(Customer customer) {
        while(true) {
            try {
                int choice = chooseMenu(new String[]{
                        "Customer Name",
                ...
                if(choice == 1) {
                    ...
                    customer.setCusTotalTime(Integer.parseInt(nextLine(Message.END_MSG)));
                }else if(choice == 4) {
                    System.out.print("Input Customer Total Pay : ");
                    customer.setCusTotalPay(Integer.parseInt(nextLine(Message.END_MSG)));
                }else {
                    if(customer.getCusId() == null || customer.getCusName() == null ||
                            customer.getCusTotalTime() == null || customer.getCusTotalPay() == null) {
        ...
        if(allCustomers.size() == 0) {
            ...
            while(true) {
                try {
                    ...
                    customerInfoInput(updateCustomer);
                    allCustomers.refresh(allGroups);
                }catch (InputEndException e) {
                    System.out.println(Message.ERR_MSG_INPUT_END);
                    System.out.println();
