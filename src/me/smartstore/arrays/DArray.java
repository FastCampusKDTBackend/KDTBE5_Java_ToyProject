...
public class DArray<T> implements Collections<T>{
    ...
    @Override
    public void set(int index, T object) throws IndexOutOfBoundsException, NullPointerException{
        if (index<0 || index>=size) throw new IndexOutOfBoundsException();
    ...
    @Override
    public int indexOf(T object) throws NullPointerException, ElementNotFoundException {
        if (object == null) throw new NullPointerException();
    ...
    @Override
    public void add(T object) throws NullPointerException{
        if(object == null) throw new NullPointerException();
