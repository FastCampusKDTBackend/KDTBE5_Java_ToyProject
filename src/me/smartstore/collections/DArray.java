...
public class DArray<T> implements IArray<T> { // Dynamic Array
	...
	@Override
	public int indexOf(T object) throws NullArgumentException, NoSuchElementException {
		if (object == null)
			throw new NullArgumentException(); // not found (instead of throwing exception)
	...
	public void add(T object) throws NullArgumentException {
		if (object == null)
			throw new NullArgumentException(); // if argument is null, do not add null value in array
