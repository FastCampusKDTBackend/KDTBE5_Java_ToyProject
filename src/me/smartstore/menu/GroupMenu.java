...
public class GroupMenu implements Menu {
    ...
    protected GroupType chooseGroup() {
        while (true) {
            try {
                ...
                String choice = nextLine(Message.EXIT_FLAG);
    ...
    protected void chooseParameter(Group group) {
        while (true) {
            try {
                int choice = chooseMenu(Stream.of(ParameterMenu.values()).map(m -> m.toString()).toArray(String[]::new));
